...
class AboutController extends Controller
{
    public function AboutPage(){
      $aboutPage = About::find(2);
      return view('admin.about_page.about_page_all', compact('aboutPage'));
    }//end method

    public function UpdateAbout(Request   $request){
       $about_id = $request->id;
      // @unlink(public_path('upload/about_images/'.$aboutPage->about_image));
    ...
    public function AboutTab(){
      ...
      $aboutPage = About::find(2);
      return view('admin.frontend.home_all.abouttab', compact('aboutPage'));
    }//end method
    ...
    public function UpdateMultiImage(Request $request){
        ...
        return redirect()->route('all.multi.page')->with($notification);
