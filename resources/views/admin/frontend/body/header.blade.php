   ...
   <header>
    ...
    <li class="{{ ($route == 'about.tab')? 'active' : '' }}"><a href="{{ route('about.tab') }}">About</a></li>
    <li><a href="">Services</a></li>
    <li class="{{ ($route == 'home.portfolio')? 'active' : '' }}" class="menu-item-has-children"><a href="{{ route('home.portfolio') }}">Portfolio</a>
