@extends('admin.frontend.main_master')

@section('main')

@section('title')
Home | LaraCode Website
...
<!-- banner-area -->
@include('admin.frontend.home_all.home_slide')
<!-- banner-area-end -->

<!-- about-area -->
@include('admin.frontend.home_all.about')
<!-- about-area-end -->
...
<!-- portfolio-area -->
@include('admin.frontend.home_all.portfolio')
<!-- portfolio-area-end -->
...
<!-- blog-area -->
@include('admin.frontend.home_all.home_blog')
<!-- blog-area-end -->
